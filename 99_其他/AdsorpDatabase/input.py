...
if __name__ == "__main__":
    ...
    # scf(vasp_scf, db_path, num_list=[100,100,100,100,100,100,100,100,100], adsorb_info={"H":1}) # num_list为吸附0，1，2...个结构的计算数量
    # sr(vasp_relax, db_path, num_list=[2,2,2,2,2,2,2,2,2], adsorb_info={"H":1})
